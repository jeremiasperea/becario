...
_SYSTEM_PROMPT = (
    ...
    "'creá la carpeta W y relajá el bulk de W para bcc, fcc y hcp' -> "
    "paso 1: crear_directorio, destino_remoto=W; "
    "paso 2: preparar_calculo, tipo_calculo=relajacion, formula=W, "
    "red_cristalina=bcc; "
    "paso 3: preparar_calculo, tipo_calculo=relajacion, formula=W, "
    "red_cristalina=fcc; "
    "paso 4: preparar_calculo, tipo_calculo=relajacion, formula=W, "
    "red_cristalina=hcp "
    "(CADA paso de cálculo lleva SU formula y SU red_cristalina — "
    "repetilos en cada paso, no los omitas)\n"
